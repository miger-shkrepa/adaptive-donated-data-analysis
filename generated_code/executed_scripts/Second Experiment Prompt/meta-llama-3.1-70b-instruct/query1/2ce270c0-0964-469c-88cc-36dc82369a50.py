    ...
    try:
        ...
        if os.path.exists(locations_of_interest_path):
            ...
            with open(locations_of_interest_path, 'r') as file:
                ...
                # Extract topics of interest from the 'locations_of_interest.json' file
...
def write_topics_to_csv(topics_of_interest):
    try:
        ...
        raise ValueError("Error: An unexpected error occurred while writing to the CSV file - " + str(e))
...
def main():
    try:
        ...
        print(e)
        # Write an empty CSV file if the root directory does not exist
