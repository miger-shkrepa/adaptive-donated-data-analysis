...
def get_user_engagement(root_dir):
    try:
        ...
        required_files = [story_likes_path, story_reaction_sticker_reactions_path, emoji_story_reactions_path, emoji_sliders_path, polls_path, quizzes_path, questions_path]
