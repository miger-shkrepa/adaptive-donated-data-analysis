                                ...
                                for saved_post in saved_posts_data:
                                    ...
                                    if "string_map_data" in saved_post and "Saved on" in saved_post["string_map_data"] and "href" in saved_post["string_map_data"]["Saved on"] and "timestamp" in saved_post["string_map_data"]["Saved on"]:
                                        ...
                                        if "href" in saved_post_data and "timestamp" in saved_post_data:
                                            ...
                                            # Check if the saved post href is the same as the liked post href and the saved post timestamp is greater than the liked post timestamp
                                            if saved_post_href == post_href and saved_post_timestamp > post_timestamp:
                                                # Add the liked post href to the list of profiles that do not follow back
