...
if not os.path.exists(messages_dir):
    print("The 'messages' directory does not exist.")
else:
    inbox_dir = os.path.join(messages_dir, "inbox")
    if not os.path.exists(inbox_dir):
        print("The 'inbox' directory does not exist.")
    else:
        for user_folder in os.listdir(inbox_dir):
            user_folder_path = os.path.join(inbox_dir, user_folder)
                        ...
                        try:
                            with open(message_file_path, "r") as f:
                                ...
                                for message in data["messages"]:
                                    if "sender_name" in message and message["sender_name"] == "your_username":
