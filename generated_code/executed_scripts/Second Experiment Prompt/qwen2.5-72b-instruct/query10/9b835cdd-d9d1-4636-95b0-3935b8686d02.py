...
def get_views_data(root_dir):
    ...
    if os.path.exists(videos_watched_path):
        ...
        print("Warning: videos_watched.json not found, treating its contribution as 0.")

    return accounts, posts_views, videos_views

def write_to_csv(accounts, posts_views, videos_views):
...
def main():
    ...
    try:
        ...
        write_to_csv(accounts, posts_views, videos_views)
