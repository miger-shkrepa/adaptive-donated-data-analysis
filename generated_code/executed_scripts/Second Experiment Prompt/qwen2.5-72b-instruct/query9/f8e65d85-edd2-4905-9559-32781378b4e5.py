...
def get_following_profiles(root_dir):
    ...
    following_profiles = [item["string_list_data"][0]["value"] for item in data["structure"]["relationships_following"]]
...
def get_followers_profiles(root_dir):
    ...
    followers_profiles = [item["string_list_data"][0]["value"] for item in data["structure"]]
