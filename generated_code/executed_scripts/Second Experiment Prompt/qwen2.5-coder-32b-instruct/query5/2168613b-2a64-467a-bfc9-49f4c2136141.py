...
def read_login_activity(root_dir):
    ...
    try:
        ...
        raise ValueError(f"ValueError: Error reading or decoding login_activity.json - {e}") from e
    ...
    try:
        ...
        raise ValueError(f"ValueError: Error processing login_activity.json - {e}") from e
...
def generate_csv(root_dir):
    ...
    try:
        ...
        raise IOError(f"IOError: Error writing to CSV file - {e}") from e
