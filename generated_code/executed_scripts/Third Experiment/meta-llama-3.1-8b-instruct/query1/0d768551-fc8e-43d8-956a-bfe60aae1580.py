    ...
    if filename.endswith(".json"):
        ...
        with open(os.path.join(root_dir, filename), 'r') as file:
            ...
            if "ads_information" in data:
                ...
                topics_of_interest.append("ads")
            elif "your_instagram_activity" in data:
                # Extract the topics of interest from the JSON data
                topics_of_interest.append("instagram")
            elif "apps_and_websites_off_of_instagram" in data:
                # Extract the topics of interest from the JSON data
                topics_of_interest.append("apps_and_websites")
            elif "connections" in data:
                # Extract the topics of interest from the JSON data
                topics_of_interest.append("connections")
