...
def get_following_profiles(root_dir):
    ...
    try:
        ...
        return [entry['string_list_data'][0]['value'] for entry in following_data['relationships_following']]
    except FileNotFoundError:
        return []
...
def get_followers_profiles(root_dir):
    ...
    try:
        ...
        return [entry['string_list_data'][0]['value'] for entry in followers_data['relationships_follow_requests_received']]
    except FileNotFoundError:
        return []
