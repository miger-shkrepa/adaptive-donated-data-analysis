...
# Sort the user interactions by the sum of post likes, story likes, and comments
sorted_users = sorted(user_interactions.items(), key=lambda x: sum(x[1]), reverse=True)
