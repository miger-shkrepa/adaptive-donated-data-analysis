            ...
            for file_name in file_names:
                ...
                if file_name == 'posts_viewed.json':
                    ...
                    try:
                        ...
                        raise ValueError("Error: Failed to parse JSON in file 'posts_viewed.json'.")
                ...
                # Check if file is 'in-app_message.json'
                    ...
                    try:
                        ...
                        raise ValueError("Error: Failed to parse JSON in file 'in-app_message.json'.")

        # Calculate accounts that have been viewed but not liked
