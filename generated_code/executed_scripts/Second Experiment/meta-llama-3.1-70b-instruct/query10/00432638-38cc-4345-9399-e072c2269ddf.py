...
def get_account_views(root_dir):
    ...
    try:
        ...
        raise ValueError("ValueError: Error parsing JSON - " + str(e))

    except Exception as e:
        raise ValueError("ValueError: An error occurred - " + str(e))
...
def save_to_csv(account_views):
    try:
        ...
        raise ValueError("ValueError: Error saving to CSV - " + str(e))
