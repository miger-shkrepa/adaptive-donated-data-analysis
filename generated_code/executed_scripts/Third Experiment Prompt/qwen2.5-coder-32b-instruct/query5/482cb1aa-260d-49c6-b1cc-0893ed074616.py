...
def read_login_activity(root_dir):
    ...
    try:
        ...
        raise ValueError(f"ValueError: Failed to read or decode the login activity file. Reason: {e}")
    ...
    try:
        ...
        raise ValueError(f"ValueError: Failed to process login activity data. Reason: {e}")
...
def generate_csv(root_dir):
    ...
    try:
        ...
        raise IOError(f"IOError: Failed to write to the CSV file. Reason: {e}")
