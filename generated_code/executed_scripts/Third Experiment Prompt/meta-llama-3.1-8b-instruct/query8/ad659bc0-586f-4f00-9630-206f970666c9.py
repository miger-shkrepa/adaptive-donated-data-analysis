            ...
            for key, value in string_map_data.items():
                ...
                if isinstance(value, dict) and "value" in value:
                    ...
                    if key in ["Post Likes", "Story Likes", "Comments"]:
                        ...
                        result["Post Likes" if key == "Post Likes" else "Story Likes" if key == "Story Likes" else "Comments"].append(value_value)
...
# Sort the result by the number of interactions
interactions = [int(y) for y in result["Post Likes"] + result["Story Likes"] + result["Comments"]]
result["User"] = [x for _, x in sorted(zip(interactions, result["User"]), reverse=True)]
