...
def process_json_file(file_path):
    try:
        with open(file_path, "r") as file:
            ...
            if "likes_media_likes" in json_data["structure"]:
            ...
            elif "story_activities_story_likes" in json_data["structure"]:
                for item in json_data["structure"]["story_activities_story_likes"]:
                    ...
                    result["Comments"].append(0)
            elif "likes_comment_likes" in json_data["structure"]:
                for item in json_data["structure"]["likes_comment_likes"]:
                    user = item["title"]
