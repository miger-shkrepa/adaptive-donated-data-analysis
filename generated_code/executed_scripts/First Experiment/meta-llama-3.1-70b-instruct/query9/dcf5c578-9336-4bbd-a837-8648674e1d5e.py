...
try:
    ...
    for subdir in os.listdir(root_dir):
        ...
        if os.path.isdir(subdir_path) and subdir == 'followers_and_following':
            ...
            for filename in os.listdir(subdir_path):
                ...
                if filename == 'following.json':
                    ...
                    # Extract the profiles the user follows from the 'following.json' file
                ...
                # Check if the file is 'followers_1.json'
                    ...
                    # Extract the profiles that follow the user from the 'followers_1.json' file
