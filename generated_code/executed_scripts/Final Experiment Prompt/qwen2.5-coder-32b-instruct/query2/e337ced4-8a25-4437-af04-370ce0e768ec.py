    ...
    try:
        ...
        with open(json_file_path, 'r') as json_file:
            ...
            for entry in data["impressions_history_ads_seen"]:
                ...
                if "string_map_data" not in entry or "Author" not in entry["string_map_data"] or "value" not in entry["string_map_data"]["Author"]:
                    raise ValueError("ValueError: The required keys are missing in one of the entries in the JSON data.")
