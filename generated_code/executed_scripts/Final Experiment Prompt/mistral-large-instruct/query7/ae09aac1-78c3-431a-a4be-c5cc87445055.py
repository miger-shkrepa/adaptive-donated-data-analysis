    ...
    for filename in os.listdir(story_interactions_dir):
        if filename.endswith(".json"):
            ...
            try:
                ...
                raise ValueError("ValueError: An error occurred while processing file: {}. Error: {}".format(file_path, str(e)))
...
def save_to_csv(user_engagement, output_path):
    try:
        ...
        raise ValueError("ValueError: An error occurred while writing to CSV. Error: {}".format(str(e)))
