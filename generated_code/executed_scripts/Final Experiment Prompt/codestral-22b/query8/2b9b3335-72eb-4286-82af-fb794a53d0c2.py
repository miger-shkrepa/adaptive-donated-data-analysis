...
try:
    ...
    print("Warning: The liked posts file does not exist. Skipping this file.")
...
if os.path.exists(story_likes_path):
    try:
        ...
        print("Warning: The story likes file could not be opened. Skipping this file.")
else:
    print("Warning: The story likes file does not exist. Skipping this file.")
...
if os.path.exists(reels_comments_path):
    try:
        ...
        print("Warning: The reels comments file could not be opened. Skipping this file.")
else:
    print("Warning: The reels comments file does not exist. Skipping this file.")
