...
story_interactions = ["story_activities_emoji_sliders", "story_activities_emoji_quick_reactions", "story_activities_polls", "story_activities_questions", "story_activities_quizzes", "story_activities_story_likes", "story_activities_reaction_sticker_reactions"]

# Iterate over the story interaction sections
for section in story_interactions:
    # Define the path to the story interaction files
    section_path = os.path.join(root_dir, "your_instagram_activity", "story_interactions", section)

    # Check if the section directory exists
    if not os.path.exists(section_path):
        continue

    # Iterate over the files in the section directory
