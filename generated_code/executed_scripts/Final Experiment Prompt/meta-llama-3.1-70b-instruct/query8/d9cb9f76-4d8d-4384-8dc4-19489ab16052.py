...
def get_interactions(root_dir):
    ...
    try:
        ...
        raise FileNotFoundError("FileNotFoundError: The file 'liked_posts.json' does not exist.")
    ...
    try:
        ...
        raise FileNotFoundError("FileNotFoundError: The file 'story_likes.json' does not exist.")
    ...
    try:
        ...
        raise FileNotFoundError("FileNotFoundError: The file 'reels_comments.json' does not exist.")
