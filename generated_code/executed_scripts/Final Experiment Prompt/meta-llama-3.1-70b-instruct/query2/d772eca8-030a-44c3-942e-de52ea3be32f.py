...
def get_company_ads_viewed(root_dir):
    ...
    try:
        ...
        for ad in data.get("impressions_history_ads_seen", []):
            ...
            company_name = ad.get("string_map_data", {}).get("Author", {}).get("value")
...
def save_to_csv(company_ads_viewed):
    ...
    Args:
    company_ads_viewed (dict): A dictionary where the keys are the company names and the values are the number of ads viewed.
    """
