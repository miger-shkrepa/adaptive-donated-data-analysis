...
with open("query_responses/results.csv", "w", newline="") as csvfile:
    ...
    for change in profile_changes:
        ...
        changed = change.get("Changed", {}).get("value", "")
        new_value = change.get("New Value", {}).get("value", "")
        change_date = change.get("Change Date", {}).get("value", "")

        # Write the profile change to the CSV file
