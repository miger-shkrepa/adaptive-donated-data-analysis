"""
First Experiment of Master Thesis.
                ...
                if model == "meta-llama-3.1-8b-instruct":
                    ...
                    while error_count <= max_attempts:
                        ...
                        if not result["error"]:
                            ...
                            os.makedirs(f"generated_code/executed_scripts/First Experiment/{model}/{query_dir_name}", exist_ok=True)
                            with open(f"generated_code/executed_scripts/First Experiment/{model}/{query_dir_name}/{experiment_id}.py", "w",
                                      encoding="utf-8") as f:
